    ...
    <div className="homepage">
      ...
      <div className="intro-section" style={{ display: 'flex' }}>
        <div>
          ...
          <ul>
            <li><p>All the stocks from NSE is available for Trading</p></li>
            <li><p>Platform to Learn and apply new knowledge without any risk of losing your money</p></li>
            <li><p>Free to use</p></li>
            <li><p>Real time Market simulation</p></li>
          </ul>
        </div>
